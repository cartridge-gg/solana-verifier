use felt::Felt;
use stark_commit::eval_composition_polynomial_inner::EvalCompositionPolynomialInner;
...
pub fn eval_composition_polynomial_inner(
    ...
    let pow0 = point.pow_felt(
        &(global_values
            .trace_length
            .floor_div(&felt_nonzero!(FELT_4096))),
    );
    ...
    let pow21 = trace_generator.pow_felt(
        &(global_values
            .trace_length
            .floor_div(&felt_nonzero!(FELT_64))),
    );
    ...
    let bitwise_sum_var_8_0 = column3_row32 * FELT_340282366920938463463374607431768211456
    ...
    let value = (column1_row8 + global_values.half_offset_size
    ...
    let value = (column1_row4 + global_values.half_offset_size
    ...
    let value = (column1_row12 + global_values.half_offset_size
    ...
    let value = ((FELT_1 - cpu_decode_opcode_range_check_bit_9) * column5_row12
    ...
    let value = (column5_row10 - column5_row2 * column5_row12)
        * domain24.field_div(&felt_nonzero!(domain5));
    let total_sum = total_sum + constraint_coefficients[13] * value;

    // Constraint: cpu/update_registers/update_pc/pc_cond_negative.
    let value = ((FELT_1 - cpu_decode_opcode_range_check_bit_9) * column1_row16
    ...
    let value = (cpu_decode_opcode_range_check_bit_12 * (column1_row9 - column5_row8))
        .field_div(&felt_nonzero!(domain5));
    ...
    let value = (cpu_decode_opcode_range_check_bit_14 * (column1_row9 - column5_row12))
        .field_div(&felt_nonzero!(domain5));
    ...
    let value = ((memory_address_diff_0 - FELT_1) * (column2_row1 - column2_row3))
        * domain26.field_div(&felt_nonzero!(domain1));
    ...
    let value = (column6_inter1_row1 - global_values.diluted_check_final_cum_val)
        .field_div(&felt_nonzero!(domain26));
    ...
    let value = (column5_row57 * (column4_row3 - (column4_row11 + column4_row11)))
    ...
    let value = (column4_row2047 * (column4_row1547 - FELT_8 * column4_row1571))
        .field_div(&felt_nonzero!(domain19));
    ...
    let value = (column1_row4106 - (column1_row1034 + FELT_1))
    ...
    let value = (column1_row138 - global_values.initial_range_check_addr)
        .field_div(&felt_nonzero!(domain25));
    ...
    let value = (bitwise_sum_var_0_0 + bitwise_sum_var_8_0 - column1_row43)
    ...
    let value =
        (column1_row75 - (column1_row171 + column1_row235)).field_div(&felt_nonzero!(domain9));
    ...
    let value = ((column3_row176 + column3_row240) * FELT_16 - column3_row2)
    ...
    let value = (column1_row202 - (global_values.initial_poseidon_addr + FELT_1))
        .field_div(&felt_nonzero!(domain25));
    ...
    let value = (column1_row458 - (global_values.initial_poseidon_addr + FELT_2))
        .field_div(&felt_nonzero!(domain25));
    ...
    let value = (column5_row201 + poseidon_poseidon_full_rounds_state1_cubed_0
        - (poseidon_poseidon_full_rounds_state0_cubed_0
            + poseidon_poseidon_full_rounds_state2_cubed_0
    ...
    let value = (column1_row715 + poseidon_poseidon_full_rounds_state1_cubed_7
        - (poseidon_poseidon_full_rounds_state0_cubed_7
            + poseidon_poseidon_full_rounds_state2_cubed_7))
        .field_div(&felt_nonzero!(domain16));
