...
impl ExtendedProofData for BidirectionalStackAccount {
    fn get_autogenerated_pows(&self) -> &[Felt; POWS_SIZE] {
        unreachable!("get_autogenerated_pows not supported in verifier4")
    }

    fn get_autogenerated_pows_mut(&mut self) -> &mut [Felt; POWS_SIZE] {
        unreachable!("get_autogenerated_pows_mut not supported in verifier4")
    }

    fn get_pows_and_domains_mut(&mut self) -> (&[Felt; POWS_SIZE], &mut [Felt; DOMAINS_SIZE]) {
        unreachable!("get_pows_and_domains_mut not supported in verifier4")
    }
...
impl ProofDataDecommitment for BidirectionalStackAccount {
    fn get_proof_data_references<T: Sized>(
        ...
        unreachable!("get_proof_data_references not supported in verifier2")
    }
    fn get_stark_commitment_and_proof<T: Sized, P: Sized>(&self) -> (&T, &P) {
        unreachable!("get_stark_commitment_and_proof not supported in verifier2")
    }
    fn get_stark_commitment_and_proof_mut<T: Sized, P: Sized>(&mut self) -> (&mut T, &mut P) {
        unreachable!("get_stark_commitment_and_proof_mut not supported in verifier2")
    }
    fn get_constraint_coefficients(&self) -> &[Felt; N_CONSTRAINTS] {
        unreachable!("get_constraint_coefficients not supported in verifier2")
    }
...
// Dummy implementation of FullProofData for verifier4 (not actually used)
impl ProofDataVerification for BidirectionalStackAccount {
    fn get_proof_data_references<T: Sized>(
        ...
        unreachable!("get_proof_data_references not supported in verifier4")
    }
    ...
    fn get_constraint_coefficients(&self) -> &[Felt; N_CONSTRAINTS] {
        unreachable!("get_constraint_coefficients not supported in 4")
    }

    fn get_constraint_coefficients_mut(&mut self) -> &mut [Felt; N_CONSTRAINTS] {
        unreachable!("get_constraint_coefficients_mut not supported in verifier4")
    }
