...
// use stark::swiftness::commitment::table::types::{Commitment as TableCommitment, Decommitment};
// use stark::swiftness::commitment::vector::config::Config as VectorConfig;
// use stark::swiftness::commitment::vector::types::{Commitment as VectorCommitment, Query};
// use stark::{
...
//     // Original authentications from the test
...
//     // Decommitment values (n_columns * n_queries = 5 * 10 = 50 values)
//     let decommitment_values = vec![
//         // Query 0 (5 columns)
//         Felt::from_hex("0x12346ea425a6aebc8c323a401410cc325aabaf99b54e600a7271f146488aa2d")
//             .unwrap(),
//         Felt::from_hex("0x1aabe006a27bfa5f93bde192ff552adbef87058e62546c831ed14ce94866ac1")
...
//         Felt::from_hex("0x7c3355a75f6b36a95068b68d48e7539cd97531b7478e2cf7d2dc85b32bafc66")
//             .unwrap(),
//         Felt::from_hex("0xb6f3a522577229ac26f12df90daaf376afbd960ee4b0ab07f270bf9c5da56a").unwrap(),
//         Felt::from_hex("0x174cfc44eb57da0eda6ae9407db71c5144940f05ef51f858bc8e229d15703e2")
//             .unwrap(),
//         Felt::from_hex("0x2220da78b33e155482bdf0534dc30fc17fe059a7b9e30f710ee2681a8151484")
//             .unwrap(),
...
//     // Create VectorWitness using trait
//     let mut authentications_funvec = FunVec::default();
//     for auth in authentications {
//         authentications_funvec.push(auth);
//     }
//     let witness = stark::swiftness::commitment::vector::types::Witness {
//         authentications: authentications_funvec,
//     };
//     witness.push_to_stack(&mut stack);

//     // Create Decommitment using trait
//     let mut decommitment_values_funvec = FunVec::default();
...
//     let query_objects: Vec<Query> = queries
//         .iter()
//         .map(|(index, value)| Query::new(*index, *value))
//         .collect();
//     Query::push_queries_to_stack(&query_objects, &mut stack);
...
//     let n_columns = Felt::from(5 as u64);
