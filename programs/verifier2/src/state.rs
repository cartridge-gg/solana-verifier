...
impl ExtendedProofData for BidirectionalStackAccount {
    fn get_autogenerated_pows(&self) -> &[Felt; POWS_SIZE] {
        unimplemented!("get_autogenerated_pows not supported in verifier2")
    }

    fn get_autogenerated_pows_mut(&mut self) -> &mut [Felt; POWS_SIZE] {
        unimplemented!("get_autogenerated_pows_mut not supported in verifier2")
    }

    fn get_pows_and_domains_mut(&mut self) -> (&[Felt; POWS_SIZE], &mut [Felt; DOMAINS_SIZE]) {
        unimplemented!("get_pows_and_domains_mut not supported in verifier2")
    }
...
impl CachedProofData for BidirectionalStackAccount {
    fn get_stark_commitment_proof_and_cache<T: Sized, P: Sized, C: Sized>(&self) -> (&T, &P, &C) {
        unreachable!("get_stark_commitment_proof_and_cache not supported in verifier2")
    }
