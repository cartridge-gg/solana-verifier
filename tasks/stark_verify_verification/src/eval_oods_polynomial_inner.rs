...
pub enum EvalOodsPolynomialInnerPhase {
    ...
    ComputeConstraints8,
    ComputeConstraints9,
    ComputeConstraints10,
    ComputeConstraints11,
    ComputeConstraints12,
    ComputeConstraints13,
    ComputeConstraints14,
    ComputeConstraints15,
    ComputeConstraints16,
    ComputeConstraints17,
    ComputeConstraints18,
    ComputeConstraints19,
    ComputeConstraints20,
    Done,
}
...
#[inline(never)]
fn compute_powers1<T: BidirectionalStack + ProofData + ProofDataVerification + CacheStorage>(
...
#[inline(never)]
fn compute_powers2<T: BidirectionalStack + ProofData + ProofDataVerification + CacheStorage>(
    obj: &mut EvalOodsPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    let autogenerated_pows = stack.get_autogenerated_pows_mut();
...
#[inline(never)]
fn compute_powers3<T: BidirectionalStack + ProofData + ProofDataVerification + CacheStorage>(
    obj: &mut EvalOodsPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    let autogenerated_pows = stack.get_autogenerated_pows_mut();
    ...
    obj.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints1;
    vec![]
}

#[inline(never)]
fn compute_constraints1<T: BidirectionalStack + ProofData + ProofDataVerification + CacheStorage>(
    obj: &mut EvalOodsPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
...
fn compute_constraints2<T: BidirectionalStack + ProofData + ProofDataVerification + CacheStorage>(
    ...
    obj.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints3;
    vec![]
}

#[inline(never)]
fn compute_constraints3<T: BidirectionalStack + ProofData + ProofDataVerification + CacheStorage>(
    obj: &mut EvalOodsPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    // Get all references at once to avoid borrowing conflicts
    ...
    let value = (column1 - oods_values[28]).field_div(&felt_nonzero!(
        obj.point - autogenerated_pows[20] * obj.oods_point
    ));
    total_sum += constraint_coefficients[28] * value;

    let value = (column1 - oods_values[29]).field_div(&felt_nonzero!(
        obj.point - autogenerated_pows[35] * obj.oods_point
    ));
    total_sum += constraint_coefficients[29] * value;

    let value = (column1 - oods_values[30]).field_div(&felt_nonzero!(
        obj.point - autogenerated_pows[36] * obj.oods_point
    ));
    total_sum += constraint_coefficients[30] * value;

    obj.total_sum = total_sum;

    obj.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints4;
    vec![]
}

#[inline(never)]
fn compute_constraints4<T: BidirectionalStack + ProofData + ProofDataVerification + CacheStorage>(
    obj: &mut EvalOodsPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    // Get all references at once to avoid borrowing conflicts
...
fn compute_constraints6<T: BidirectionalStack + ProofData + ProofDataVerification + CacheStorage>(
    ...
    obj.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints7;
    vec![]
}

#[inline(never)]
fn compute_constraints7<T: BidirectionalStack + ProofData + ProofDataVerification + CacheStorage>(
    obj: &mut EvalOodsPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    // Get all references at once to avoid borrowing conflicts
    ...
    let value = (column3 - oods_values[70]).field_div(&felt_nonzero!(
        obj.point - autogenerated_pows[22] * obj.oods_point
    ));
    total_sum += constraint_coefficients[70] * value;

    obj.total_sum = total_sum;

    obj.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints8;
    vec![]
}

#[inline(never)]
fn compute_constraints8<T: BidirectionalStack + ProofData + ProofDataVerification + CacheStorage>(
    obj: &mut EvalOodsPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    // Get all references at once to avoid borrowing conflicts
...
fn compute_constraints10<T: BidirectionalStack + ProofData + ProofDataVerification + CacheStorage>(
    ...
    obj.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints11;
    vec![]
}

#[inline(never)]
fn compute_constraints11<T: BidirectionalStack + ProofData + ProofDataVerification + CacheStorage>(
    obj: &mut EvalOodsPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    // Get all references at once to avoid borrowing conflicts
    ...
    let value = (column4 - oods_values[109]).field_div(&felt_nonzero!(
        obj.point - autogenerated_pows[52] * obj.oods_point
    ));
    total_sum += constraint_coefficients[109] * value;

    let value = (column4 - oods_values[110]).field_div(&felt_nonzero!(
        obj.point - autogenerated_pows[58] * obj.oods_point
    ));
    total_sum += constraint_coefficients[110] * value;

    obj.total_sum = total_sum;

    obj.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints12;
    vec![]
}

#[inline(never)]
fn compute_constraints12<T: BidirectionalStack + ProofData + ProofDataVerification + CacheStorage>(
    obj: &mut EvalOodsPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    // Get all references at once to avoid borrowing conflicts
...
fn compute_constraints13<T: BidirectionalStack + ProofData + ProofDataVerification + CacheStorage>(
    ...
    obj.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints14;
    vec![]
}

#[inline(never)]
fn compute_constraints14<T: BidirectionalStack + ProofData + ProofDataVerification + CacheStorage>(
    obj: &mut EvalOodsPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    // Get all references at once to avoid borrowing conflicts
    ...
    let value = (column5 - oods_values[139]).field_div(&felt_nonzero!(
        obj.point - autogenerated_pows[21] * obj.oods_point
    ));
    total_sum += constraint_coefficients[139] * value;

    let value = (column5 - oods_values[140]).field_div(&felt_nonzero!(
        obj.point - autogenerated_pows[23] * obj.oods_point
    ));
    total_sum += constraint_coefficients[140] * value;

    obj.total_sum = total_sum;

    obj.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints15;
    vec![]
}

#[inline(never)]
fn compute_constraints15<T: BidirectionalStack + ProofData + ProofDataVerification + CacheStorage>(
    obj: &mut EvalOodsPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    // Get all references at once to avoid borrowing conflicts
...
fn compute_constraints19<T: BidirectionalStack + ProofData + ProofDataVerification + CacheStorage>(
    ...
    obj.total_sum = total_sum;
    obj.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints20;
    vec![]
}

#[inline(never)]
fn compute_constraints20<T: BidirectionalStack + ProofData + ProofDataVerification + CacheStorage>(
    obj: &mut EvalOodsPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    // Get all references at once to avoid borrowing conflicts
    ...
    let oods_point_to_deg = obj.oods_point.pow_felt(&Felt::from(CONSTRAINT_DEGREE)); // Layout::CONSTRAINT_DEGREE = 2

    let value = (column_values[8] - oods_values[192])
        .field_div(&felt_nonzero!(obj.point - oods_point_to_deg));
...
impl Executable for EvalOodsPolynomialInner {
    fn execute<T: BidirectionalStack + ProofData + ProofDataVerification + CacheStorage>(
        &mut self,
        stack: &mut T,
    ) -> Vec<Vec<u8>> {
        match self.phase {
            ...
            EvalOodsPolynomialInnerPhase::ComputeConstraints1 => compute_constraints1(self, stack),
            EvalOodsPolynomialInnerPhase::ComputeConstraints2 => compute_constraints2(self, stack),
            EvalOodsPolynomialInnerPhase::ComputeConstraints3 => compute_constraints3(self, stack),
            EvalOodsPolynomialInnerPhase::ComputeConstraints4 => compute_constraints4(self, stack),
            EvalOodsPolynomialInnerPhase::ComputeConstraints5 => compute_constraints5(self, stack),
            EvalOodsPolynomialInnerPhase::ComputeConstraints6 => compute_constraints6(self, stack),
            EvalOodsPolynomialInnerPhase::ComputeConstraints7 => compute_constraints7(self, stack),
            EvalOodsPolynomialInnerPhase::ComputeConstraints8 => compute_constraints8(self, stack),
            EvalOodsPolynomialInnerPhase::ComputeConstraints9 => compute_constraints9(self, stack),
            EvalOodsPolynomialInnerPhase::ComputeConstraints10 => {
                compute_constraints10(self, stack)
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints11 => {
                compute_constraints11(self, stack)
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints12 => {
                compute_constraints12(self, stack)
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints13 => {
                compute_constraints13(self, stack)
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints14 => {
                compute_constraints14(self, stack)
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints15 => {
                compute_constraints15(self, stack)
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints16 => {
                compute_constraints16(self, stack)
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints17 => {
                compute_constraints17(self, stack)
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints18 => {
                compute_constraints18(self, stack)
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints19 => {
                compute_constraints19(self, stack)
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints20 => {
                compute_constraints20(self, stack)
            }
