    ...
    fn execute<T: BidirectionalStack + ProofData + ProofDataVerification + CacheStorage>(
        ...
        match self.phase {
            EvalOodsPolynomialInnerPhase::ComputePowers => {
                ...
                println!("oods_point: {:?}", self.oods_point);
                println!("trace_generator: {:?}", self.trace_generator);
                ...
                self.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints1;
                vec![]
            }

            EvalOodsPolynomialInnerPhase::ComputeConstraints1 => {
                ...
                // println!("autogenerated_pows: {:?}", autogenerated_pows);
                // Fetch columns
                ...
                println!("total_sum after constraints 10: {:?}", self.total_sum);

                self.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints2;
                vec![]
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints2 => {
                // Get all references at once to avoid borrowing conflicts
                let (autogenerated_pows, oods_values, constraint_coefficients, column_values) =
                    stack.get_proof_data_references::<StarkProof>();
                ...
                self.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints3;
                vec![]
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints3 => {
                // Get all references at once to avoid borrowing conflicts
                let (autogenerated_pows, oods_values, constraint_coefficients, column_values) =
                    stack.get_proof_data_references::<StarkProof>();
                ...
                self.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints4;
                vec![]
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints4 => {
                // Get all references at once to avoid borrowing conflicts
                let (autogenerated_pows, oods_values, constraint_coefficients, column_values) =
                    stack.get_proof_data_references::<StarkProof>();
                ...
                self.total_sum = total_sum;
                println!("total_sum after constraints 40: {:?}", self.total_sum);

                self.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints5;
                vec![]
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints5 => {
                // Get all references at once to avoid borrowing conflicts
                let (autogenerated_pows, oods_values, constraint_coefficients, column_values) =
                    stack.get_proof_data_references::<StarkProof>();
                ...
                self.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints6;
                vec![]
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints6 => {
                // Get all references at once to avoid borrowing conflicts
                let (autogenerated_pows, oods_values, constraint_coefficients, column_values) =
                    stack.get_proof_data_references::<StarkProof>();
                ...
                self.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints7;
                vec![]
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints7 => {
                // Get all references at once to avoid borrowing conflicts
                let (autogenerated_pows, oods_values, constraint_coefficients, column_values) =
                    stack.get_proof_data_references::<StarkProof>();
                ...
                self.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints8;
                vec![]
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints8 => {
                // Get all references at once to avoid borrowing conflicts
                let (autogenerated_pows, oods_values, constraint_coefficients, column_values) =
                    stack.get_proof_data_references::<StarkProof>();
                ...
                self.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints9;
                vec![]
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints9 => {
                // Get all references at once to avoid borrowing conflicts
                let (autogenerated_pows, oods_values, constraint_coefficients, column_values) =
                    stack.get_proof_data_references::<StarkProof>();
                ...
                self.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints10;
                vec![]
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints10 => {
                ...
                self.total_sum = total_sum;
                println!("total_sum after constraints 100: {:?}", self.total_sum);

                self.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints11;
                vec![]
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints11 => {
                ...
                self.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints12;
                vec![]
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints12 => {
                ...
                self.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints13;
                vec![]
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints13 => {
                ...
                self.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints14;
                vec![]
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints14 => {
                ...
                self.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints15;
                vec![]
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints15 => {
                ...
                self.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints16;
                vec![]
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints16 => {
                ...
                self.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints17;
                vec![]
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints17 => {
                ...
                self.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints18;
                vec![]
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints18 => {
                ...
                self.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints19;
                vec![]
            }
            EvalOodsPolynomialInnerPhase::ComputeConstraints19 => {
                ...
                self.total_sum = total_sum;
                self.phase = EvalOodsPolynomialInnerPhase::ComputeConstraints20;
                vec![]
            }
