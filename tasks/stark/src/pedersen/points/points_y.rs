...
impl PedersenPointsY {
    pub fn new(pedersen_point: Felt) -> Self {
        Self {
            step: PedersenPointsYPhase::Init,
            pedersen_point,
            result: Felt::ZERO,
        }
    }
...
impl Default for PedersenPointsY {
    fn default() -> Self {
        Self::new(Felt::ZERO)
    }
}

impl Executable for PedersenPointsY {
    fn execute<T: BidirectionalStack + ProofData + StarkCommitmentTrait>(
        &mut self,
        stack: &mut T,
    ) -> Vec<Vec<u8>> {
        match self.step {
            PedersenPointsYPhase::Init => {
                ...
                self.result = res;
                self.step = PedersenPointsYPhase::ComputePointStep1;
                vec![]
            }
            PedersenPointsYPhase::ComputePointStep1 => {
                let mut res = self.result;
                let point = self.pedersen_point;
                res = res * point
                    + Felt::from_hex_unchecked(
                ...
                self.result = res;
                self.step = PedersenPointsYPhase::ComputePointStep2;
                vec![]
            }
            PedersenPointsYPhase::ComputePointStep2 => {
                let mut res = self.result;
                let point = self.pedersen_point;
                res = res * point
                    + Felt::from_hex_unchecked(
                ...
                self.result = res;
                self.step = PedersenPointsYPhase::ComputePointStep3;
                vec![]
            }
            PedersenPointsYPhase::ComputePointStep3 => {
                let mut res = self.result;
                let point = self.pedersen_point;
                res = res * point
                    + Felt::from_hex_unchecked(
                ...
                self.result = res;
                self.step = PedersenPointsYPhase::ComputePointStep4;
                vec![]
            }
            PedersenPointsYPhase::ComputePointStep4 => {
                let mut res = self.result;
                let point = self.pedersen_point;
                res = res * point
                    + Felt::from_hex_unchecked(
                ...
                self.result = res;
                self.step = PedersenPointsYPhase::ComputePointStep5;
                vec![]
            }
            PedersenPointsYPhase::ComputePointStep5 => {
                let mut res = self.result;
                let point = self.pedersen_point;
                res = res * point
                    + Felt::from_hex_unchecked(
                ...
                self.result = res;
                self.step = PedersenPointsYPhase::ComputePointStep6;
                vec![]
            }
            PedersenPointsYPhase::ComputePointStep6 => {
                let mut res = self.result;
                let point = self.pedersen_point;
                res = res * point
                    + Felt::from_hex_unchecked(
                ...
                self.result = res;
                self.step = PedersenPointsYPhase::ComputePointStep7;
                vec![]
            }
            PedersenPointsYPhase::ComputePointStep7 => {
                let mut res = self.result;
                let point = self.pedersen_point;
                res = res * point
                    + Felt::from_hex_unchecked(
                ...
                self.result = res;
                self.step = PedersenPointsYPhase::ComputePointStep8;
                vec![]
            }
            PedersenPointsYPhase::ComputePointStep8 => {
                let pedersen_points = self.result;
                stack.push_front(&pedersen_points.to_bytes_be()).unwrap();
                self.step = PedersenPointsYPhase::Done;
                vec![]
            }
            PedersenPointsYPhase::Done => {
                vec![]
            }
        }
    }
