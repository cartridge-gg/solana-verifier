...
pub enum EvalCompositionPolynomialInnerPhase {
    ComputePowers,
    ComputeDomains,
    ComputeCpuDecodeIntermediates,
    ComputeCpuDecodeConstraints,
    ComputeCpuOperandsConstraints,
    ComputeCallRet,
    ComputeInitialFinal,
    ComputeMemory,
    ComputeRangeCheck16,
    ComputeDilutedCheck,
    ComputePedersenStep1,
    ComputePedersenStep2,
    ComputeRangeCheck,
    ComputeBitwise,
    ComputePoseidonStep1,
    ComputePoseidonStep2,
    ComputePoseidonStep3,
    ComputePoseidonStep4,
    Done,
}
...
// Helper functions with #[inline(never)] to reduce stack frame size
#[inline(never)]
fn compute_powers<T: BidirectionalStack + ProofDataDecommitment>(
    obj: &mut EvalCompositionPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    ...
    autogenerated_pows[13] = obj.trace_generator.pow_felt(&(trace_length - FELT_512));
    autogenerated_pows[14] = obj.trace_generator.pow_felt(&(trace_length - FELT_256));
    autogenerated_pows[15] = obj.trace_generator.pow_felt(&(trace_length - FELT_4096));
    autogenerated_pows[16] = obj.trace_generator.pow_felt(&(trace_length - FELT_4));
    autogenerated_pows[17] = obj.trace_generator.pow_felt(&(trace_length - FELT_2));
    autogenerated_pows[18] = obj.trace_generator.pow_felt(&(trace_length - FELT_16));
    autogenerated_pows[19] = obj
        .trace_generator
        .pow_felt(&(trace_length.floor_div(&felt::felt_nonzero!(FELT_2))));
    autogenerated_pows[20] = obj
        .trace_generator
        .pow_felt(&((FELT_255 * trace_length).floor_div(&felt::felt_nonzero!(FELT_256))));
    autogenerated_pows[21] = obj
        .trace_generator
    ...
    obj.phase = EvalCompositionPolynomialInnerPhase::ComputeDomains;
    vec![]
}

#[inline(never)]
fn compute_domains<T: BidirectionalStack + ProofDataDecommitment>(
    obj: &mut EvalCompositionPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    ...
    domains[24] = obj.point - autogenerated_pows[18];
    domains[25] = obj.point - FELT_1;
    domains[26] = obj.point - autogenerated_pows[17];
    domains[27] = obj.point - autogenerated_pows[16];
    domains[28] = obj.point - autogenerated_pows[15];
    domains[29] = obj.point - autogenerated_pows[14];
    domains[30] = obj.point - autogenerated_pows[13];
    obj.phase = EvalCompositionPolynomialInnerPhase::ComputeCpuDecodeIntermediates;
    vec![]
}

#[inline(never)]
fn compute_cpu_decode_intermediates<T: BidirectionalStack + ProofDataDecommitment>(
    obj: &mut EvalCompositionPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    ...
    bits[2] = column_row!(mv, 0, 2) - (column_row!(mv, 0, 3) + column_row!(mv, 0, 3));
    bits[3] = column_row!(mv, 0, 3) - (column_row!(mv, 0, 4) + column_row!(mv, 0, 4));
    bits[4] = column_row!(mv, 0, 4) - (column_row!(mv, 0, 5) + column_row!(mv, 0, 5));
    bits[5] = column_row!(mv, 0, 5) - (column_row!(mv, 0, 6) + column_row!(mv, 0, 6));
    bits[6] = column_row!(mv, 0, 6) - (column_row!(mv, 0, 7) + column_row!(mv, 0, 7));
    bits[7] = column_row!(mv, 0, 7) - (column_row!(mv, 0, 8) + column_row!(mv, 0, 8));
    bits[8] = column_row!(mv, 0, 8) - (column_row!(mv, 0, 9) + column_row!(mv, 0, 9));
    bits[9] = column_row!(mv, 0, 9) - (column_row!(mv, 0, 10) + column_row!(mv, 0, 10));
    bits[10] = column_row!(mv, 0, 10) - (column_row!(mv, 0, 11) + column_row!(mv, 0, 11));
    bits[11] = column_row!(mv, 0, 11) - (column_row!(mv, 0, 12) + column_row!(mv, 0, 12));
    bits[12] = column_row!(mv, 0, 12) - (column_row!(mv, 0, 13) + column_row!(mv, 0, 13));
    bits[13] = column_row!(mv, 0, 13) - (column_row!(mv, 0, 14) + column_row!(mv, 0, 14));
    bits[14] = column_row!(mv, 0, 14) - (column_row!(mv, 0, 15) + column_row!(mv, 0, 15));

    obj.phase = EvalCompositionPolynomialInnerPhase::ComputeCpuDecodeConstraints;
    vec![]
}

#[inline(never)]
fn compute_cpu_decode_constraints<T: BidirectionalStack + ProofDataDecommitment>(
    obj: &mut EvalCompositionPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    ...
    let flag_pc_update_regular_0 = FELT_1 - (bits[7] + bits[8] + bits[9]);
    let fp_update_regular_0 = FELT_1 - (bits[12] + bits[13]);

    let mut sum = FELT_0;
    let mut value =
        (bits[0] * bits[0] - bits[0]) * domains[4].field_div(&felt_nonzero!(domains[0]));

    sum += constraints_coef[0] * value;

    value = column_row!(mv, 0, 0).field_div(&felt_nonzero!(domains[4]));

    sum += constraints_coef[1] * value;

    let value = (column_row!(mv, 1, 1)
        - (((column_row!(mv, 0, 0) * g.offset_size + column_row!(mv, 4, 4)) * g.offset_size
            + column_row!(mv, 4, 8))
            * g.offset_size
            + column_row!(mv, 4, 0)))
    .field_div(&felt_nonzero!(domains[5]));

    sum += constraints_coef[2] * value;

    let value = (flag_op1_base_op0_0 * flag_op1_base_op0_0 - flag_op1_base_op0_0)
        .field_div(&felt_nonzero!(domains[5]));

    sum += constraints_coef[3] * value;

    let value =
        (flag_res_op1_0 * flag_res_op1_0 - flag_res_op1_0).field_div(&felt_nonzero!(domains[5]));
    sum += constraints_coef[4] * value;

    let value = (flag_pc_update_regular_0 * flag_pc_update_regular_0 - flag_pc_update_regular_0)
        .field_div(&felt_nonzero!(domains[5]));
    sum += constraints_coef[5] * value;

    let value = (fp_update_regular_0 * fp_update_regular_0 - fp_update_regular_0)
        .field_div(&felt_nonzero!(domains[5]));
    sum += constraints_coef[6] * value;

    obj.total_sum += sum;
    obj.phase = EvalCompositionPolynomialInnerPhase::ComputeCpuOperandsConstraints;
    vec![]
}

#[inline(never)]
fn compute_cpu_operands_constraints<T: BidirectionalStack + ProofDataDecommitment>(
    obj: &mut EvalCompositionPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    ...
    let npc_reg_0 = column_row!(mask_values, 1, 0) + bits[2] + FELT_1;

    let mut total_sum = FELT_0;

    let value = (column_row!(mask_values, 1, 8) + global_values.half_offset_size
        - (bits[0] * column_row!(mask_values, 5, 8)
            + (FELT_1 - bits[0]) * column_row!(mask_values, 5, 0)
    ...
    let value = (column_row!(mask_values, 1, 4) + global_values.half_offset_size
        - (bits[1] * column_row!(mask_values, 5, 8)
            + (FELT_1 - bits[1]) * column_row!(mask_values, 5, 0)
    ...
    let value = (column_row!(mask_values, 1, 12) + global_values.half_offset_size
        - (bits[2] * column_row!(mask_values, 1, 0)
            + bits[4] * column_row!(mask_values, 5, 0)
            + bits[3] * column_row!(mask_values, 5, 8)
            + flag_op1_base_op0_0 * column_row!(mask_values, 1, 5)
    ...
    let value = ((FELT_1 - bits[9]) * column_row!(mask_values, 5, 12)
        - (bits[5] * (column_row!(mask_values, 1, 5) + column_row!(mask_values, 1, 13))
            + bits[6] * column_row!(mask_values, 5, 4)
            + flag_res_op1_0 * column_row!(mask_values, 1, 13)))
    .field_div(&felt_nonzero!(domains[5]));
    total_sum += constraint_coefficients[11] * value;

    let value = (column_row!(mask_values, 5, 2) - bits[9] * column_row!(mask_values, 1, 9))
    ...
    let value = ((FELT_1 - bits[9]) * column_row!(mask_values, 1, 16)
        + column_row!(mask_values, 5, 2)
            * (column_row!(mask_values, 1, 16)
                - (column_row!(mask_values, 1, 0) + column_row!(mask_values, 1, 13)))
        - (flag_pc_update_regular_0 * npc_reg_0
            + bits[7] * column_row!(mask_values, 5, 12)
            + bits[8] * (column_row!(mask_values, 1, 0) + column_row!(mask_values, 5, 12))))
        * domains[24].field_div(&felt_nonzero!(domains[5]));
    total_sum += constraint_coefficients[14] * value;

    // Constraint: cpu/update_registers/update_pc/pc_cond_positive.
    let value = ((column_row!(mask_values, 5, 10) - bits[9])
    ...
    let value = (column_row!(mask_values, 5, 16)
        - (column_row!(mask_values, 5, 0)
            + bits[10] * column_row!(mask_values, 5, 12)
            + bits[11]
            + bits[12] * FELT_2))
        * domains[24].field_div(&felt_nonzero!(domains[5]));
    ...
    let value = (column_row!(mask_values, 5, 24)
        - (fp_update_regular_0 * column_row!(mask_values, 5, 8)
            + bits[13] * column_row!(mask_values, 1, 9)
            + bits[12] * (column_row!(mask_values, 5, 0) + FELT_2)))
        * domains[24].field_div(&felt_nonzero!(domains[5]));
    total_sum += constraint_coefficients[17] * value;

    obj.total_sum += total_sum;

    obj.phase = EvalCompositionPolynomialInnerPhase::ComputeCallRet;
    vec![]
}

#[inline(never)]
fn compute_call_ret<T: BidirectionalStack + ProofDataDecommitment>(
    obj: &mut EvalCompositionPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    ...
    let value = (bits[12] * (column_row!(mask_values, 1, 9) - column_row!(mask_values, 5, 8)))
        .field_div(&felt_nonzero!(domains[5]));
    total_sum += constraint_coefficients[18] * value;

    // Constraint: cpu/opcodes/call/push_pc.
    let value = (bits[12]
        * (column_row!(mask_values, 1, 5) - (column_row!(mask_values, 1, 0) + bits[2] + FELT_1)))
        .field_div(&felt_nonzero!(domains[5]));
    total_sum += constraint_coefficients[19] * value;

    // Constraint: cpu/opcodes/call/off0.
    let value = (bits[12] * (column_row!(mask_values, 4, 0) - global_values.half_offset_size))
        .field_div(&felt_nonzero!(domains[5]));
    ...
    let value = (bits[12] * (bits[12] + bits[12] + FELT_1 + FELT_1 - (bits[0] + bits[1] + FELT_4)))
        .field_div(&felt_nonzero!(domains[5]));
    ...
    let value = (bits[13] * (bits[7] + bits[0] + bits[3] + flag_res_op1_0 - FELT_4))
        .field_div(&felt_nonzero!(domains[5]));
    total_sum += constraint_coefficients[25] * value;

    // Constraint: cpu/opcodes/assert_eq/assert_eq.
    let value = (bits[14] * (column_row!(mask_values, 1, 9) - column_row!(mask_values, 5, 12)))
        .field_div(&felt_nonzero!(domains[5]));
    total_sum += constraint_coefficients[26] * value;

    obj.total_sum += total_sum;
    obj.phase = EvalCompositionPolynomialInnerPhase::ComputeInitialFinal;

    vec![]
}

#[inline(never)]
fn compute_initial_final<T: BidirectionalStack + ProofDataDecommitment>(
    obj: &mut EvalCompositionPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    ...
    obj.total_sum += total_sum;
    obj.phase = EvalCompositionPolynomialInnerPhase::ComputeMemory;
    vec![]
}

#[inline(never)]
fn compute_memory<T: BidirectionalStack + ProofDataDecommitment>(
    obj: &mut EvalCompositionPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    let (domains, mask_values, global_values, constraint_coefficients, _, _) =
    ...
    let memory_address_diff_0 = column_row!(mask_values, 2, 2) - column_row!(mask_values, 2, 0);
    ...
    let value = (column_row!(mask_values, 2, 0) - FELT_1).field_div(&felt_nonzero!(domains[25]));
    ...
    obj.total_sum += total_sum;
    println!("total_sum after 40: {:?}", obj.total_sum);
    obj.phase = EvalCompositionPolynomialInnerPhase::ComputeRangeCheck16;
    vec![]
}

#[inline(never)]
fn compute_range_check16<T: BidirectionalStack + ProofDataDecommitment>(
    obj: &mut EvalCompositionPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    let (domains, mask_values, global_values, constraint_coefficients, _, _) =
    ...
    let value = ((global_values.range_check16_perm_interaction_elm
        ...
        * column_row!(mask_values, 7, 5)
        - (global_values.range_check16_perm_interaction_elm - column_row!(mask_values, 4, 4))
            * column_row!(mask_values, 7, 1))
    ...
    let range_check16_diff_0 = column_row!(mask_values, 4, 6) - column_row!(mask_values, 4, 2);
    ...
    obj.total_sum += total_sum;
    println!("total_sum after 46: {:?}", obj.total_sum);
    obj.phase = EvalCompositionPolynomialInnerPhase::ComputeDilutedCheck;
    vec![]
}

#[inline(never)]
fn compute_diluted_check<T: BidirectionalStack + ProofDataDecommitment>(
    obj: &mut EvalCompositionPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    let (domains, mask_values, global_values, constraint_coefficients, _, _) =
    ...
    let value = (column_row!(mask_values, 6, 1) - FELT_1).field_div(&felt_nonzero!(domains[25]));
    total_sum += constraint_coefficients[50] * value;

    // Constraint: diluted_check/first_element.
    let value = (column_row!(mask_values, 3, 1) - global_values.diluted_check_first_elm)
        .field_div(&felt_nonzero!(domains[25]));
    ...
    let value = (column_row!(mask_values, 6, 1) - global_values.diluted_check_final_cum_val)
        .field_div(&felt_nonzero!(domains[26]));
    total_sum += constraint_coefficients[53] * value;

    println!("total_sum after 53: {:?}", obj.total_sum + total_sum);
    obj.total_sum += total_sum;
    obj.phase = EvalCompositionPolynomialInnerPhase::ComputePedersenStep1;
    vec![]
}

#[inline(never)]
fn compute_pedersen_step1<T: BidirectionalStack + ProofDataDecommitment>(
    obj: &mut EvalCompositionPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    let (domains, mask_values, global_values, constraint_coefficients, _, _) =
    ...
    let value = (column_row!(mask_values, 5, 57)
        - column_row!(mask_values, 4, 2047)
            * (column_row!(mask_values, 4, 1539)
                - (column_row!(mask_values, 4, 1547) + column_row!(mask_values, 4, 1547))))
    .field_div(&felt_nonzero!(domains[19]));
    ...
    let value = (column_row!(mask_values, 4, 2047)
        * (column_row!(mask_values, 4, 1547) - FELT_8 * column_row!(mask_values, 4, 1571)))
    .field_div(&felt_nonzero!(domains[19]));
    ...
    let value = (column_row!(mask_values, 4, 2047)
        - (column_row!(mask_values, 4, 2011)
            ...
            * (column_row!(mask_values, 4, 1571)
                - (column_row!(mask_values, 4, 1579) + column_row!(mask_values, 4, 1579))))
    .field_div(&felt_nonzero!(domains[19]));
    ...
    obj.total_sum += total_sum;
    println!("total_sum after 65: {:?}", obj.total_sum);
    obj.phase = EvalCompositionPolynomialInnerPhase::ComputePedersenStep2;
    vec![]
}

#[inline(never)]
fn compute_pedersen_step2<T: BidirectionalStack + ProofDataDecommitment>(
    obj: &mut EvalCompositionPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    let (domains, mask_values, global_values, constraint_coefficients, _, _) =
    ...
    let value = (column_row!(mask_values, 1, 4106) - (column_row!(mask_values, 1, 1034) + FELT_1))
    ...
    let value = (column_row!(mask_values, 1, 2058) - (column_row!(mask_values, 1, 10) + FELT_1))
        .field_div(&felt_nonzero!(domains[23]));
    ...
    let value = (column_row!(mask_values, 1, 1034) - (column_row!(mask_values, 1, 2058) + FELT_1))
        .field_div(&felt_nonzero!(domains[23]));
    total_sum += constraint_coefficients[78] * value;

    obj.total_sum += total_sum;
    println!("total_sum after 78: {:?}", obj.total_sum);
    obj.phase = EvalCompositionPolynomialInnerPhase::ComputeRangeCheck;
    vec![]
}

#[inline(never)]
fn compute_range_check<T: BidirectionalStack + ProofDataDecommitment>(
    obj: &mut EvalCompositionPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    let (domains, mask_values, global_values, constraint_coefficients, _, _) =
    ...
    let range_check_builtin_value1_0 =
        range_check_builtin_value0_0 * global_values.offset_size + column_row!(mask_values, 4, 44);

    let range_check_builtin_value2_0 =
        range_check_builtin_value1_0 * global_values.offset_size + column_row!(mask_values, 4, 76);

    let range_check_builtin_value3_0 =
        range_check_builtin_value2_0 * global_values.offset_size + column_row!(mask_values, 4, 108);

    let range_check_builtin_value4_0 =
        range_check_builtin_value3_0 * global_values.offset_size + column_row!(mask_values, 4, 140);

    let range_check_builtin_value5_0 =
        range_check_builtin_value4_0 * global_values.offset_size + column_row!(mask_values, 4, 172);

    let range_check_builtin_value6_0 =
        range_check_builtin_value5_0 * global_values.offset_size + column_row!(mask_values, 4, 204);

    let range_check_builtin_value7_0 =
        range_check_builtin_value6_0 * global_values.offset_size + column_row!(mask_values, 4, 236);
    ...
    let value = (column_row!(mask_values, 1, 394) - (column_row!(mask_values, 1, 138) + FELT_1))
    ...
    let value = (column_row!(mask_values, 1, 138) - global_values.initial_range_check_addr)
        .field_div(&felt_nonzero!(domains[25]));
    total_sum += constraint_coefficients[81] * value;

    obj.total_sum += total_sum;
    println!("total_sum after 81: {:?}", obj.total_sum);

    obj.phase = EvalCompositionPolynomialInnerPhase::ComputeBitwise;
    vec![]
}

#[inline(never)]
fn compute_bitwise<T: BidirectionalStack + ProofDataDecommitment>(
    obj: &mut EvalCompositionPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    let (domains, mask_values, global_values, constraint_coefficients, _, _) =
    ...
    let bitwise_sum_var_8_0 = column_row!(mask_values, 3, 32)
        * FELT_340282366920938463463374607431768211456
        + column_row!(mask_values, 3, 36) * FELT_680564733841876926926749214863536422912
        + column_row!(mask_values, 3, 40) * FELT_1361129467683753853853498429727072845824
        + column_row!(mask_values, 3, 44) * FELT_2722258935367507707706996859454145691648
    ...
    let value = (column_row!(mask_values, 1, 106) - (column_row!(mask_values, 1, 42) + FELT_1))
        * domains[10].field_div(&felt_nonzero!(domains[7]));
    total_sum += constraint_coefficients[83] * value;

    // Constraint: bitwise/x_or_y_addr.
    let value = (column_row!(mask_values, 1, 74) - (column_row!(mask_values, 1, 234) + FELT_1))
        .field_div(&felt_nonzero!(domains[9]));
    total_sum += constraint_coefficients[84] * value;

    // Constraint: bitwise/next_var_pool_addr.
    let value = (column_row!(mask_values, 1, 298) - (column_row!(mask_values, 1, 74) + FELT_1))
        * domains[29].field_div(&felt_nonzero!(domains[9]));
    total_sum += constraint_coefficients[85] * value;

    // Constraint: bitwise/partition.
    let value = (bitwise_sum_var_0_0 + bitwise_sum_var_8_0 - column_row!(mask_values, 1, 43))
    ...
    let value = ((column_row!(mask_values, 3, 176) + column_row!(mask_values, 3, 240)) * FELT_16
        - column_row!(mask_values, 3, 2))
    .field_div(&felt_nonzero!(domains[9]));
    total_sum += constraint_coefficients[89] * value;

    // Constraint: bitwise/unique_unpacking193.
    let value = ((column_row!(mask_values, 3, 180) + column_row!(mask_values, 3, 244)) * FELT_16
        - column_row!(mask_values, 3, 130))
    .field_div(&felt_nonzero!(domains[9]));
    total_sum += constraint_coefficients[90] * value;

    // Constraint: bitwise/unique_unpacking194.
    let value = ((column_row!(mask_values, 3, 184) + column_row!(mask_values, 3, 248)) * FELT_16
        - column_row!(mask_values, 3, 66))
    .field_div(&felt_nonzero!(domains[9]));
    total_sum += constraint_coefficients[91] * value;

    // Constraint: bitwise/unique_unpacking195.
    let value = ((column_row!(mask_values, 3, 188) + column_row!(mask_values, 3, 252)) * FELT_256
        - column_row!(mask_values, 3, 194))
    .field_div(&felt_nonzero!(domains[9]));
    total_sum += constraint_coefficients[92] * value;
    obj.total_sum += total_sum;
    println!("total_sum after 92: {:?}", obj.total_sum);
    obj.phase = EvalCompositionPolynomialInnerPhase::ComputePoseidonStep1;
    vec![]
}

#[inline(never)]
fn compute_poseidon_step1<T: BidirectionalStack + ProofDataDecommitment>(
    obj: &mut EvalCompositionPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    let (domains, mask_values, global_values, constraint_coefficients, _, _) =
    ...
    let value = (column_row!(mask_values, 1, 266) - global_values.initial_poseidon_addr)
        .field_div(&felt_nonzero!(domains[25]));
    total_sum += constraint_coefficients[93] * value;

    // Constraint: poseidon/param_0/addr_input_output_step.
    let value = (column_row!(mask_values, 1, 778) - (column_row!(mask_values, 1, 266) + FELT_3))
    ...
    let value = (column_row!(mask_values, 1, 202) - (global_values.initial_poseidon_addr + FELT_1))
        .field_div(&felt_nonzero!(domains[25]));
    total_sum += constraint_coefficients[95] * value;

    // Constraint: poseidon/param_1/addr_input_output_step.
    let value = (column_row!(mask_values, 1, 714) - (column_row!(mask_values, 1, 202) + FELT_3))
        * domains[30].field_div(&felt_nonzero!(domains[12]));
    total_sum += constraint_coefficients[96] * value;

    // Constraint: poseidon/param_2/init_input_output_addr.
    let value = (column_row!(mask_values, 1, 458) - (global_values.initial_poseidon_addr + FELT_2))
        .field_div(&felt_nonzero!(domains[25]));
    total_sum += constraint_coefficients[97] * value;

    // Constraint: poseidon/param_2/addr_input_output_step.
    let value = (column_row!(mask_values, 1, 970) - (column_row!(mask_values, 1, 458) + FELT_3))
        * domains[30].field_div(&felt_nonzero!(domains[12]));
...
fn compute_poseidon_step3<T: BidirectionalStack + ProofDataDecommitment>(
    ...
    let value = (column_row!(mask_values, 5, 201) + poseidon_bits[1]
        - (poseidon_bits[0] + poseidon_bits[2] + global_values.poseidon_poseidon_full_round_key1))
        * domains[13].field_div(&felt_nonzero!(domains[8]));
    total_sum += constraint_coefficients[108] * value;

    // Constraint: poseidon/poseidon/full_round2.
    let value = (column_row!(mask_values, 5, 169) + poseidon_bits[2] + poseidon_bits[2]
        - (poseidon_bits[0] + poseidon_bits[1] + global_values.poseidon_poseidon_full_round_key2))
        * domains[13].field_div(&felt_nonzero!(domains[8]));
    ...
    let value = (column_row!(mask_values, 1, 715) + poseidon_bits[4]
        - (poseidon_bits[3] + poseidon_bits[5]))
        .field_div(&felt_nonzero!(domains[16]));
    total_sum += constraint_coefficients[111] * value;

    // Constraint: poseidon/poseidon/last_full_round2.
    let value = (column_row!(mask_values, 1, 971) + poseidon_bits[5] + poseidon_bits[5]
        - (poseidon_bits[3] + poseidon_bits[4]))
        .field_div(&felt_nonzero!(domains[16]));
    total_sum += constraint_coefficients[112] * value;
    obj.total_sum += total_sum;
    println!("total_sum after 112: {:?}", obj.total_sum);
    obj.phase = EvalCompositionPolynomialInnerPhase::ComputePoseidonStep4;
    vec![]
}

#[inline(never)]
fn compute_poseidon_step4<T: BidirectionalStack + ProofDataDecommitment>(
    obj: &mut EvalCompositionPolynomialInner,
    stack: &mut T,
) -> Vec<Vec<u8>> {
    let (domains, mask_values, global_values, constraint_coefficients, _, poseidon_bits) =
    ...
    let value = (column_row!(mask_values, 5, 6) + poseidon_bits[8] + poseidon_bits[8]
        - (poseidon_bits[6]
            + poseidon_bits[7]
    ...
    let value = (column_row!(mask_values, 5, 38)
        - (FELT_8 * poseidon_bits[8]
            + FELT_4 * column_row!(mask_values, 5, 6)
            + FELT_6 * poseidon_bits[9]
    ...
    let value = (column_row!(mask_values, 5, 54)
        - (FELT_8 * poseidon_bits[9]
            + FELT_4 * column_row!(mask_values, 5, 22)
            + FELT_6 * poseidon_bits[10]
    ...
    let value = (column_row!(mask_values, 5, 97)
        - (FELT_8 * poseidon_bits[12]
            + FELT_4 * column_row!(mask_values, 5, 33)
            + FELT_6 * poseidon_bits[13]
    ...
    let value = (column_row!(mask_values, 5, 521)
        - (FELT_16 * poseidon_bits[15]
            + FELT_8 * column_row!(mask_values, 5, 641)
            + FELT_16 * poseidon_bits[16]
    ...
    let value = (column_row!(mask_values, 5, 553)
        - (FELT_8 * poseidon_bits[15]
            + FELT_4 * column_row!(mask_values, 5, 641)
            + FELT_6 * poseidon_bits[16]
            + column_row!(mask_values, 5, 673)
            + column_row!(mask_values, 5, 673)
            + FELT_3618502788666131213697322783095070105623107215331596699973092056135872020479
                * poseidon_bits[17]
    ...
    obj.phase = EvalCompositionPolynomialInnerPhase::Done;
    vec![]
}

#[inline(never)]
fn done<T: BidirectionalStack + ProofDataDecommitment>(
    _obj: &mut EvalCompositionPolynomialInner,
    _stack: &mut T,
) -> Vec<Vec<u8>> {
    vec![]
}
...
impl Executable for EvalCompositionPolynomialInner {
    fn execute<T: BidirectionalStack + ProofDataDecommitment>(
        ...
        msg!(
            "EvalCompositionPolynomialInner::execute phase: {:?}",
            self.phase as u8
        );
        match self.phase {
            EvalCompositionPolynomialInnerPhase::ComputePowers => compute_powers(self, stack),
            EvalCompositionPolynomialInnerPhase::ComputeDomains => compute_domains(self, stack),
            EvalCompositionPolynomialInnerPhase::ComputeCpuDecodeIntermediates => {
                compute_cpu_decode_intermediates(self, stack)
            }
            EvalCompositionPolynomialInnerPhase::ComputeCpuDecodeConstraints => {
                compute_cpu_decode_constraints(self, stack)
            }
            EvalCompositionPolynomialInnerPhase::ComputeCpuOperandsConstraints => {
                compute_cpu_operands_constraints(self, stack)
            }
            EvalCompositionPolynomialInnerPhase::ComputeCallRet => compute_call_ret(self, stack),
            EvalCompositionPolynomialInnerPhase::ComputeInitialFinal => {
                compute_initial_final(self, stack)
            }
            EvalCompositionPolynomialInnerPhase::ComputeMemory => compute_memory(self, stack),
            EvalCompositionPolynomialInnerPhase::ComputeRangeCheck16 => {
                compute_range_check16(self, stack)
            }
            EvalCompositionPolynomialInnerPhase::ComputeDilutedCheck => {
                compute_diluted_check(self, stack)
            }
            EvalCompositionPolynomialInnerPhase::ComputePedersenStep1 => {
                compute_pedersen_step1(self, stack)
            }
            EvalCompositionPolynomialInnerPhase::ComputePedersenStep2 => {
                compute_pedersen_step2(self, stack)
            }
            EvalCompositionPolynomialInnerPhase::ComputeRangeCheck => {
                compute_range_check(self, stack)
            }
            EvalCompositionPolynomialInnerPhase::ComputeBitwise => compute_bitwise(self, stack),
            EvalCompositionPolynomialInnerPhase::ComputePoseidonStep1 => {
                compute_poseidon_step1(self, stack)
            }
            EvalCompositionPolynomialInnerPhase::ComputePoseidonStep2 => {
                compute_poseidon_step2(self, stack)
            }
            EvalCompositionPolynomialInnerPhase::ComputePoseidonStep3 => {
                compute_poseidon_step3(self, stack)
            }
            EvalCompositionPolynomialInnerPhase::ComputePoseidonStep4 => {
                compute_poseidon_step4(self, stack)
            }
            EvalCompositionPolynomialInnerPhase::Done => done(self, stack),
        }
    }
