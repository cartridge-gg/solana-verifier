    ...
    fn execute<T: BidirectionalStack + ProofDataDecommitment>(
        ...
        match self.phase {
            ...
            EvalCompositionPolynomialInnerPhase::ComputeDomains => {
                ...
                self.phase = EvalCompositionPolynomialInnerPhase::ComputeCpuDecodeIntermediates;
                vec![]
            }
            ...
            EvalCompositionPolynomialInnerPhase::ComputeCpuDecodeIntermediates => {
                ...
                self.phase = EvalCompositionPolynomialInnerPhase::ComputeCpuDecodeConstraints;
                vec![]
            }
            EvalCompositionPolynomialInnerPhase::ComputeCpuDecodeConstraints => {
                ...
                self.total_sum += sum;
                self.phase = EvalCompositionPolynomialInnerPhase::ComputeCpuOperandsConstraints;
                vec![]
            }
            EvalCompositionPolynomialInnerPhase::ComputeCpuOperandsConstraints => {
                ...
                self.phase = EvalCompositionPolynomialInnerPhase::ComputeCallRet;
                vec![]
            }
            EvalCompositionPolynomialInnerPhase::ComputeCallRet => {
                ...
                self.total_sum += total_sum;
                self.phase = EvalCompositionPolynomialInnerPhase::ComputeInitialFinal;
            ...
            EvalCompositionPolynomialInnerPhase::ComputeInitialFinal => {
                ...
                self.total_sum += total_sum;
                self.phase = EvalCompositionPolynomialInnerPhase::ComputeMemory;
                vec![]
            }
            EvalCompositionPolynomialInnerPhase::ComputeMemory => {
                ...
                self.total_sum += total_sum;
                println!("total_sum after 40: {:?}", self.total_sum);
                self.phase = EvalCompositionPolynomialInnerPhase::ComputeRangeCheck16;
                vec![]
            }
            EvalCompositionPolynomialInnerPhase::ComputeRangeCheck16 => {
                ...
                self.total_sum += total_sum;
                println!("total_sum after 46: {:?}", self.total_sum);
                self.phase = EvalCompositionPolynomialInnerPhase::ComputeDilutedCheck;
                vec![]
            }
            ...
            EvalCompositionPolynomialInnerPhase::ComputeDilutedCheck => {
                ...
                println!("total_sum after 53: {:?}", self.total_sum + total_sum);
                self.total_sum += total_sum;
                self.phase = EvalCompositionPolynomialInnerPhase::ComputePedersenStep1;
                vec![]
            }
            EvalCompositionPolynomialInnerPhase::ComputePedersenStep1 => {
                ...
                self.total_sum += total_sum;
                println!("total_sum after 65: {:?}", self.total_sum);
                self.phase = EvalCompositionPolynomialInnerPhase::ComputePedersenStep2;
                vec![]
            }
            EvalCompositionPolynomialInnerPhase::ComputePedersenStep2 => {
                ...
                self.total_sum += total_sum;
                println!("total_sum after 78: {:?}", self.total_sum);
                self.phase = EvalCompositionPolynomialInnerPhase::ComputeRangeCheck;
                vec![]
            }
            EvalCompositionPolynomialInnerPhase::ComputeRangeCheck => {
                ...
                self.total_sum += total_sum;
                println!("total_sum after 81: {:?}", self.total_sum);

                self.phase = EvalCompositionPolynomialInnerPhase::ComputeBitwise;
                vec![]
            }
            EvalCompositionPolynomialInnerPhase::ComputeBitwise => {
                ...
                self.total_sum += total_sum;
                println!("total_sum after 92: {:?}", self.total_sum);
                self.phase = EvalCompositionPolynomialInnerPhase::ComputePoseidonStep1;
                vec![]
            }
            ...
            EvalCompositionPolynomialInnerPhase::ComputePoseidonStep1 => {
                ...
                self.total_sum += total_sum;
                println!("total_sum after 102: {:?}", self.total_sum);
                self.phase = EvalCompositionPolynomialInnerPhase::ComputePoseidonStep2;
                vec![]
            }
            EvalCompositionPolynomialInnerPhase::ComputePoseidonStep2 => {
                ...
                self.phase = EvalCompositionPolynomialInnerPhase::ComputePoseidonStep3;
                vec![]
            }
            EvalCompositionPolynomialInnerPhase::ComputePoseidonStep3 => {
                ...
                self.total_sum += total_sum;
                println!("total_sum after 112: {:?}", self.total_sum);
                self.phase = EvalCompositionPolynomialInnerPhase::ComputePoseidonStep4;
                vec![]
            }
